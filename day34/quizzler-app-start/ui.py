...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score = Label(text="Score: 0", fg="white",
                           background=THEME_COLOR, font=("Arial", 20, "italic"))
        self.score.grid(column=1, row=0)

        self.question_panel = Canvas(
            width=300, height=250, highlightthickness=0)
        self.question_text = self.question_panel.create_text(150, 125,
                                                             text="Some questions here.", fill=THEME_COLOR, width=280, font=("Arial", 15, "italic"))
        self.question_panel.grid(row=1, column=0, columnspan=2, pady=50)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.question_panel.itemconfig(
